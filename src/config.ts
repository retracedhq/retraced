...
export default {
  ...
  RETRACED_NO_ANALYTICS:
    ...
    env.DO_NOT_TRACK,
  //EXPORT CONFIG
  EXPORT_VECTOR_WEBHOOK_URL: process.env.EXPORT_VECTOR_WEBHOOK_URL || env.EXPORT_VECTOR_WEBHOOK_URL,
  EXPORT_VECTOR_WEBHOOK_USERNAME:
    process.env.EXPORT_VECTOR_WEBHOOK_USERNAME || env.EXPORT_VECTOR_WEBHOOK_USERNAME,
  EXPORT_VECTOR_WEBHOOK_PASSWORD:
    process.env.EXPORT_VECTOR_WEBHOOK_PASSWORD || env.EXPORT_VECTOR_WEBHOOK_PASSWORD,
};
