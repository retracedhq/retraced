...
export default {
    ...
    SUPERCRONIC_SHA1SUM: process.env.SUPERCRONIC_SHA1SUM || env.SUPERCRONIC_SHA1SUM || "",
    ...
    SUPERCRONIC_URL: process.env.SUPERCRONIC_URL || env.SUPERCRONIC_URL || "",
    ...
    SUPERCRONIC: process.env.SUPERCRONIC || env.SUPERCRONIC || "",
    ...
    STATSD_USE_SYSDIG_NAME_REWRITER: process.env.STATSD_USE_SYSDIG_NAME_REWRITER || env.STATSD_USE_SYSDIG_NAME_REWRITER || "",
    ...
    NODE_TLS_REJECT_UNAUTHORIZED: process.env.NODE_TLS_REJECT_UNAUTHORIZED || env.NODE_TLS_REJECT_UNAUTHORIZED || "",
    NO_WARP_PIPE: process.env.NO_WARP_PIPE || env.NO_WARP_PIPE || "",
    ...
    ELASTICSEARCH_REQUEST_RETRIES: process.env.ELASTICSEARCH_REQUEST_RETRIES || env.ELASTICSEARCH_REQUEST_RETRIES || "",
    ELASTICSEARCH_REQUEST_TIMEOUT: process.env.ELASTICSEARCH_REQUEST_TIMEOUT || env.ELASTICSEARCH_REQUEST_TIMEOUT || "",
    ...
    PROCESSOR_NORMALIZE_REPAIRER_MIN_AGE_MS: process.env.PROCESSOR_NORMALIZE_REPAIRER_MIN_AGE_MS || env.PROCESSOR_NORMALIZE_REPAIRER_MIN_AGE_MS || "",
    PROCESSOR_NORMALIZE_REPAIRER_MAX_EVENTS: process.env.PROCESSOR_NORMALIZE_REPAIRER_MAX_EVENTS || env.PROCESSOR_NORMALIZE_REPAIRER_MAX_EVENTS || "",
    WARP_PIPE_REDIS_DB: process.env.WARP_PIPE_REDIS_DB || env.WARP_PIPE_REDIS_DB || "",
    TMPDIR: process.env.TMPDIR || env.TMPDIR || "",
    AUTH0_CLIENT_DOMAIN: process.env.AUTH0_CLIENT_DOMAIN || env.AUTH0_CLIENT_DOMAIN || "",
    AUTH0_CLIENT_ID: process.env.AUTH0_CLIENT_ID || env.AUTH0_CLIENT_ID || "",
    PUBLISHER_BULK_CREATE_MAX_EVENTS: process.env.PUBLISHER_BULK_CREATE_MAX_EVENTS || env.PUBLISHER_BULK_CREATE_MAX_EVENTS || "",
    PUBLISHER_CREATE_EVENT_TIMEOUT: process.env.PUBLISHER_CREATE_EVENT_TIMEOUT || env.PUBLISHER_CREATE_EVENT_TIMEOUT || "",
    ...
    NSQ_CIRCUIT_BREAKER_THRESHOLD: process.env.NSQ_CIRCUIT_BREAKER_THRESHOLD || env.NSQ_CIRCUIT_BREAKER_THRESHOLD || "",
};
