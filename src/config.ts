...
export default {
  ...
  POSTGRES_STATEMENT_TIMEOUT: process.env.POSTGRES_STATEMENT_TIMEOUT || env.POSTGRES_STATEMENT_TIMEOUT,
  ...
  MAXMIND_GEOLITE2_LICENSE_KEY: process.env.MAXMIND_GEOLITE2_LICENSE_KEY || env.MAXMIND_GEOLITE2_LICENSE_KEY,
