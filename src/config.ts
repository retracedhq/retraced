...
export default {
  ...
  VECTOR_DEFAULT_CONFIG_PATH:
    process.env.VECTOR_DEFAULT_CONFIG_PATH || env.VECTOR_DEFAULT_CONFIG_PATH || "/etc/vector/config",
  VECTOR_API_PORT: +(process.env.VECTOR_API_PORT || env.VECTOR_API_PORT || "8686"),
  VECTOR_HOST: process.env.VECTOR_HOST || env.VECTOR_HOST || "localhost",
  VECTOR_HOST_PROTOCOL: process.env.VECTOR_HOST_PROTOCOL || env.VECTOR_HOST_PROTOCOL || "http",
  VECTOR_SIDECAR_PORT: +(process.env.VECTOR_SIDECAR_PORT || env.VECTOR_SIDECAR_PORT || "3003"),
