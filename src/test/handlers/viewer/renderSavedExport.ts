...
async function setup(pool, params?) {
    ...
    if (!params.skipSavedSearch) {
        await pool.query("INSERT INTO saved_search (id, name, project_id, environment_id, group_id, query_desc) VALUES ($1, $2, $3, $4, $5, $6)", [params.invalidSearchId || "test", "test", "test", "test", "test", JSON.stringify(json)]);
    }
    ...
    await pool.query(`insert into saved_export (id, name, body, project_id, environment_id, group_id) values ($1, $2, $3, $4, $5, $6)`, ["test", "test", JSON.stringify(json), "test", "test", "test"]);
