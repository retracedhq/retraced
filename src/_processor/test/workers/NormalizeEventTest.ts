...
const ORIGINAL_EVENT = {
  ...
  crud: "c",
  group: { id: "dev", name: "dev" },
  created: "2023-01-14T15:48:44.573Z",
  actor: {
    id: "sanju@boxyhq.com",
    name: "sanjusamson",
    href: "https://rr.com",
  ...
  description: "Some record got created",
  is_failure: false,
  is_anonymous: false,
  component: "crm",
  version: "v0.0.1",
  external_id: "EXTERNAL_ID_1",
  metadata: { sorted: "false", sampled: "true" },
...
const NORMALIZED_EVENT = {
  ...
  source_ip: LOCALHOST_IP,
  version: "v0.0.1",
  id: "925099768bbc42d6adaa9a13d7ac7d6b",
  received: RECEIVED,
  canonical_time: 1673711324573,
  fields: { country: "India" },
  group: {
    project_id: "dev",
    environment_id: "dev",
...
const COMPRESSED_EVENT = { created: "2023-01-14T15:48:44.573Z" };
@suite
class NormalizeEventTest {
  ...
  public async normalizeEvent({
    ...
    const rows = [
      {
        id: "100",
        original_event: JSON.stringify(originalEvent),
        normalized_event: "",
  ...
  @params(
    ...
    "Should be able to restore original event from normalized and compressed events"
  )
