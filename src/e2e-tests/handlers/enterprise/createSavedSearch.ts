...
//     await safeQuery(`DELETE FROM retraceduser WHERE email=$1`, [
//       "test@test.com",
//     ]);
//     await safeQuery(`DELETE FROM eitapi_token WHERE environment_id=$1`, [
//       "test",
//     ]);
...
//     await safeQuery(`DELETE FROM saved_search WHERE project_id=$1 OR id=$1`, [
//       "test",
//     ]);
//   } catch (ex) {
