...
describe("Enterprise Search Group Scoping", function () {
    describe("Given the Retraced API is up and running", function () {
        ...
        context("And a call is made into the Retraced API with a standard audit event for the RetracedQA group", function () {
            ...
            context("When a call is made to create an eitapi token for a Replicated group", function () {
                ...
                context("And the eitapi token is used to call the Enterprise API GraphQL endpoint for event", function () {
