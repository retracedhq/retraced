...
describe("Create Events", function () {
  ...
  describe("Given the Retraced API is up and running", function () {
    ...
    context(
      "When a call is made into the Retraced API with the incorrect API key",
      function () {
        let httpResponse;
        beforeEach(async function () {
          const retraced = new Retraced.Client({
  ...
  describe("Given the Retraced API is up and running", function () {
    ...
    context(
      "When a call is made into the Retraced API with an invalid source_ip",
      function () {
