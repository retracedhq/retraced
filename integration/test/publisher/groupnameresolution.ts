...
describe("Group Name Resolution", function () {
  describe("Given the Retraced API is up and running", function () {
    ...
    context(
      "And a call is made into the Retraced API with only a group.id",
      () => {
        ...
        context(
          ...
          () => {
            ...
            context(
              "When a call is made to the GraphQL endpoint for the first event",
              function () {
                beforeEach(function (done) {
            ...
            context(
              "When a call is made to the GraphQL endpoint for the second event",
              function () {
                beforeEach(function (done) {
                  this.timeout(Env.EsIndexWaitMs * 2);
                  sleep(Env.EsIndexWaitMs).then(() => {
