...
describe("Viewer API", function () {
  describe("Given the Retraced API is up and running", function () {
    ...
    context(
      "And a call is made into the Retraced API with a standard audit event",
      function () {
        ...
        context(
          "And a call is made to create a viewer description scoped to a target",
          function () {
            let token;
            ...
            context(
              ...
              function () {
                ...
                context(
                  "When a call is made to the Viewer API GraphQL endpoint for the event",
                  function () {
                    let responseBody;
        ...
        context(
          "And a call is made to create a viewer descriptor",
          function () {
            let token;
            beforeEach(async () => {
              const retraced = new Retraced.Client({
            ...
            context(
              ...
              function () {
                ...
                context(
                  "When a second call is made to the Viewer API GraphQL endpoint",
                  function () {
                    let responseBody;
                    beforeEach(function (done) {
                      this.timeout(Env.EsIndexWaitMs * 2);
